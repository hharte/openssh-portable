...
#undef HAVE_STATFS // hharte 1

/* Define to 1 if you have the `statvfs' function. */
#undef HAVE_STATVFS // hharte 1
...
#define SSHDIR "/data/local/tmp/ssh"

#define _PATH_PRIVSEP_CHROOT_DIR "/data/local/tmp/ssh/empty"

#define _PATH_SSH_PROGRAM "/system/bin/ssh"

#define _PATH_SSH_USER_DIR ".ssh"

#define _PATH_SSH_USER_PREFIX "/data/local/tmp/ssh/.ssh"
