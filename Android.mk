...
LOCAL_MODULE := ssl
LOCAL_SRC_FILES := ../../android-openssl-master/libs/$(TARGET_ARCH_ABI)/libssl.so
...
LOCAL_MODULE := crypto
LOCAL_SRC_FILES := ../../android-openssl-master/libs/$(TARGET_ARCH_ABI)/libcrypto.so
LOCAL_EXPORT_C_INCLUDES := $(LOCAL_PATH)/../include/
...
LOCAL_C_INCLUDES += ../../android-openssl-master/jni/include/
...
LOCAL_C_INCLUDES := $(LOCAL_DIR)/../../android-openssl-master/jni/include/
PRIVATE_C_INCLUDES := external/openssl/openbsd-compat
